...
const users = [
  {
    id:1,
    email: 'zelayita@gmail.com',
    username: 'Zelaya123',
    password: 'Zelaya123456'
  }
]
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 px-4 py-10 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 rounded-4xl bg-[#EEEEEE] p-6 shadow-xl shadow-slate-200/50 md:p-10 md:flex-row md:items-center">
