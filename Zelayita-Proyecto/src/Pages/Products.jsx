      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-6 space-y-4">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-3xl font-semibold text-slate-900">Peliculas</h1>
            </div>
            <div className="flex items-center gap-4">
              <div className="rounded-2xl bg-white px-4 py-3 shadow-sm ring-1 ring-slate-200">
                <p className="text-sm text-slate-500">Total Peliculas</p>
          ...
          <div className="max-w-xl">
            <label htmlFor="product-search" className="sr-only">Buscar Peliculas</label>
            <input
              id="product-search"
              type="text"
              value={searchTerm}
        ...
        <div className="overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-slate-200">
          ...
          <div className="p-4">
            {loading ? (
              <div className="flex items-center justify-center py-20 text-slate-500">Cargando Peliculas...</div>
            ) : error ? (
                ...
                <table className="min-w-full divide-y divide-slate-200 text-left">
                  <thead className="bg-slate-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-sm font-semibold uppercase tracking-wide text-slate-500">Descripcion</th>
                  ...
                  <tbody className="divide-y divide-slate-200 bg-white">
                    {currentProducts.map((product) => (
                      <tr key={product.id} className="hover:bg-slate-50">
                        ...
                        <td className="px-6 py-4 align-top text-sm font-semibold text-slate-900">{product.body}</td>
